...
class TermsAndServicesVс: UIViewController {
  ...
  @IBAction func agreeBtn(_ sender: Any) {
      ...
      DispatchQueue.main.async {
          let storyboard = UIStoryboard(name: "LoginOTP", bundle: .main)
          if let vc = storyboard.instantiateViewController(withIdentifier: "VerifyPhoneNumberVс") as? VerifyPhoneNumberVс {
      ...
      //let chatDetailVc = AppStoryboard.login.getRootViewController(VerifyPhoneNumberVс.self)
      //chatDetailVc.hidesBottomBarWhenPushed = true
      //self.navigationController?.pushViewController(chatDetailVc, animated: true)
      
      //let loginVc = storyboard.instantiateViewController(withIdentifier: "VerifyPhoneNumberVс")
      //self.navigationController?.pushViewController(loginVc, animated: true)
      
      if let verifyVc = storyboard.instantiateViewController(withIdentifier: "VerifyPhoneNumberVс") as? VerifyPhoneNumberVс {
  ...
  func setupPrivacyLabel() {
      ...
      policyServicesLabel.textColor = UIColor.systemGray2  //UIColor(named: "LIGHTGRAY")
