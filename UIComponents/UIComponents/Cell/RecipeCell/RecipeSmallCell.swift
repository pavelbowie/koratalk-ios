...
public class RecipeSmallCell: UICollectionViewCell, ReusableView {
    ...
    private let userImageView: UIImageView = {
        ...
        image.layer.borderColor = UIColor.appYellow.cgColor
    ...
    private let usernameLabel: PaddingLabel = {
        ...
        label.font = .font(.ttcommonsBold, size: .xSmall)
        label.textColor = .appWhite
        label.layer.cornerRadius = 10
        label.clipsToBounds = false
        label.layer.masksToBounds = true
        label.backgroundColor = .appYellow
        return label
    }()
    ...
    private let recipeCommentAndLikeCountLabel = UILabelBuilder()
        .font(.font(.ttcommonsSemiBold, size: .small))
        .textColor(.appGrey)
        .build()
...
extension RecipeSmallCell {
    ...
    private func configureCellShadowAndRadius() {
        ...
        layer.shadowColor = UIColor.appOrange.cgColor
...
public extension RecipeSmallCell {
    ...
    func set(with viewModel: RecipeCellProtocol) {
        ...
        self.recipeCommentAndLikeCountLabel.text = viewModel.recipeCommentAndLikeCountText
    }
}
