...
public enum Asset {
  public enum Colors {
    ...
    public static let appGrey = ColorAsset(name: "appGrey")
    ...
    public static let appSecondary = ColorAsset(name: "appSecondary")
    public static let appWhite = ColorAsset(name: "appWhite")
    public static let appYellow = ColorAsset(name: "appYellow")
  }
  public enum Icons {
    public static let chats = ImageAsset(name: "chats")
    public static let chatsGreen = ImageAsset(name: "chats_green")
    public static let flows = ImageAsset(name: "flows")
    public static let flowsGreen = ImageAsset(name: "flows_green")
    ...
    public static let requests = ImageAsset(name: "requests")
    public static let requestsGreen = ImageAsset(name: "requests_green")
  ...
  public enum Images {
    public static let accept = ImageAsset(name: "accept")
    public static let acceptFill = ImageAsset(name: "accept_fill")
    public static let add = ImageAsset(name: "add")
    public static let arrowLeft = ImageAsset(name: "arrowLeft")
    public static let arrowSend = ImageAsset(name: "arrowSend")
    public static let c1 = ImageAsset(name: "c1")
    public static let c2 = ImageAsset(name: "c2")
    public static let c3 = ImageAsset(name: "c3")
    public static let c4 = ImageAsset(name: "c4")
    public static let camera = ImageAsset(name: "camera")
    public static let clip = ImageAsset(name: "clip")
    public static let def = ImageAsset(name: "def")
    public static let dismiss = ImageAsset(name: "dismiss")
    public static let dropdown = ImageAsset(name: "dropdown")
    public static let gallery = ImageAsset(name: "gallery")
    public static let hidePassword = ImageAsset(name: "hidePassword")
    public static let image = ImageAsset(name: "image")
    public static let information = ImageAsset(name: "information")
    public static let popup = ImageAsset(name: "popup")
    public static let radioChecked = ImageAsset(name: "radioChecked")
    public static let radioUnchecked = ImageAsset(name: "radioUnchecked")
    public static let sds = ImageAsset(name: "sds")
    public static let search = ImageAsset(name: "search")
    public static let send = ImageAsset(name: "send")
    public static let showPassword = ImageAsset(name: "showPassword")
    public static let warning = ImageAsset(name: "warning")
    public static let appMainLogo = ImageAsset(name: "appMainLogo")
    public static let appNavigationBarLogo = ImageAsset(name: "appNavigationBarLogo")
