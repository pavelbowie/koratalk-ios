...
final class MockChatData {
    ...
    let tim = MockUser(
        uid: "1",
        name: "UserName1",
        avatar: AssetExtractor.createLocalUrl(forImageNamed: "UserName1")!
    )
    let steve = MockUser(
        uid: "2",
        name: "UserName2",
        avatar: AssetExtractor.createLocalUrl(forImageNamed: "UserName2")!
    )
    let bob = MockUser(
        uid: "3",
        name: "UserName3",
        avatar: AssetExtractor.createLocalUrl(forImageNamed: "UserName3")!
    )
    ...
    func randomMockImage() -> MockImage {
        ...
        return MockImage(
            id: UUID().uuidString,
            thumbnail: URL(string: "https://apricus.kz.com/150/\(color)")!,
            full: URL(string: "https://apricus.kz.com/600/\(color)")!
        )
    }
